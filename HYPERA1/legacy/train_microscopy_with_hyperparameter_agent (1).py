...
def main():
    ...
    train_transforms = Compose(
        [
            ...
            # Spacingd(keys=["image", "label"], pixdim=(1.0, 1.0, 1.0), mode=("bilinear", "nearest")), # kavya:delete or change it to 1x1
    ...
    post_label = Compose([EnsureType(), AsDiscrete(to_onehot=4)])  # 4 classes
